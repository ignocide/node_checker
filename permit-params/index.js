...
//req = ["key1","key2","key3","key4"];
//req = { key1 : TYPE.NUMBER, key2 : TYPE.ARRAY, key3 : TYpE.BOOLEAN }
//req = { key1 : {type : TYPE.OBJECT , toNumber : false . allowKeyNull : true , allowValueNull : false }}
    ...
    if (reqType == TYPE.OBJECT) {
        ...
        for (let i = 0; i < reqKeys.length; i++) {
            ...
            if (typeOf(reqItemOpt) == TYPE.STRING) {
                ...
                for (let j = 0; j < reqOptKeys.length; j++) {
